...
sudo -u $username paru -Sy --noconfirm brave-bin zen-browser-bin openbangla-keyboard-bin ttf-freebanglafont ttf-indic-otf ttf-whatsapp-emoji gnome-characters ttf-firacode-nerd gnome-shell gdm gnome-control-center gnome-settings-daemon gnome-keyring nautilus sushi gnome-calculator gnome-browser-connector gnome-tweaks loupe ghostty steam gnome-system-monitor celluloid firefox chromium pipewire-jack pipewire-pulse starship wl-clipboard xclip ripgrep noto-fonts-cjk noto-fonts-extra ibus-libpinyin gcc npm pnpm cargo python python-pip uv lazygit herdr-bin opencode-bin visual-studio-code-bin libreoffice-fresh marktext-bin inkscape gimp thunderbird discord figma-linux droidcam zed dosfstools
